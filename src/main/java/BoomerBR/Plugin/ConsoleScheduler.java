  ...
  extends JavaPlugin
{
  ...
  public void onEnable()
  {
    ...
    log.log(Level.INFO, "[{0}] By BoomerBR - v{1} enabled.", new Object[] { pdfFile.getName(), pdfFile.getVersion() });
  ...
  {
    PluginDescriptionFile pdfFile = getDescription();
    log.log(Level.INFO, "[{0}] By BoomerBR - v{1} disabled.", new Object[] { pdfFile.getName(), pdfFile.getVersion() });
